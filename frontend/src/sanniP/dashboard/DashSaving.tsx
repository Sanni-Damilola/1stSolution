...
import { AiOutlineMenu, AiOutlineHome, AiFillRocket, AiOutlineLogout, AiOutlineUser } from "react-icons/ai"
        ...
        <Togg style={{color:"white",fontSize:"25px", top:"30px", left:"25px", cursor:"pointer", zIndex:"100"}} onClick={toggle} > 
            ...
            <Contain wd={ show ? "100%" : "calc(100% - 300px)" }>
                ...
                <Eben>
                    ...
                    <Even>
                        <Good>Savings</Good>
                        <Wash>Let's see how well you are doing
                        </Wash>
                    </Even>
                ...
                <Boxes>
                    ...
                    <Box style={{backgroundColor:'#c4bfbf', color:"#0d60d8"}}>
                        ...
                        <BoxText2>Strict savings automatically. Daily, weekly or monthly. 10% p.a</BoxText2>
                    ...
                    <Box style={{backgroundColor:'#d8d5d5', color:"green"}}>
                        ...
                        <BoxText2>Flexible ssavings for emergencies. Free transfers, withdrawals.
                        </BoxText2>
                    ...
                    <Box style={{backgroundColor:'#f7e0e0', color:"#60a0fa"}}>
                        ...
                        <BoxText2>Lock funds to avaoid tempatations. Upfront interest</BoxText2>
